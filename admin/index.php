...
<head>
    ...
    <title>Admin Login :: Hoechy Development LTD™</title>
</head>
...
<body>
    ...
    <section class="bg-black overflow-hidden">
            ...
            <div class="row align-items-center justify-content-center my-auto">
                <div class="col-md-10 col-lg-8 col-xl-5">
                    <div class="text-center mb-3">
                        <a href="./">
                            <img src="assets/images/logo-light.svg" width="300" alt="Logo">
                        </a>
                    </div>
                    <div class="card">
        ...
        <figure class="background background-overlay" style="background-image: url('assets/images/hero.jpg')">
        </figure>
    </section>
