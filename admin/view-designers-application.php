                                    ...
                                    <div class="card bg-opaque-white">
                                        ...
                                        <div class="card-body bg-white">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label for="company" class="form-label">Showcase Category</label>
                                                    <input type="text" class="form-control" required name="company" disabled value="<?php echo $designerCategory; ?>">
                                                </div>
