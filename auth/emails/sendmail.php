...
function sendVerificationEmail($userEmail, $token, $first_name, $last_name)
{
  ...
  <table class=\'email-wraper\'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class=\'pdl-3x pdr-3x pdb-2x\'>
                                        ...
                                        <p class=\'mgb-1x\' style="font-family:\'Helvetica\',sans-serif;font-size:14px;line-height:20px;letter-spacing:-0.2px;text-align:center">Thank you for joining <b>EasyHNF™</b><br>By clicking on the button or link below, you will be verifying your email address.</p>
                                        <p style="text-align:center;padding-bottom:35px;font-family:\'Helvetica\',Helvetica,Arial,sans-serif;font-size:14px;">
                                        <a href="https://easyhnf.com/verify_email?token=' . $token . '" class=\'btn\' style="color: #ffffff; text-decoration: none;">Verify Account</a><br>
                                        <a href="https://easyhnf.com/verify_email?token=' . $token . '" style="text-decoration: none;">https://easyhnf.com/verify_email?token=' . $token . '</a>
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
    ...
    // Create a message
    $message = (new Swift_Message('Welcome to the family👏'))
